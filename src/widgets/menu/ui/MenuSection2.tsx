...
export default function MenuSection2() {
  ...
  return (
    <section id="menu2" className="py-20 md:py-32 relative overflow-hidden" ref={ref}>
      {/* 배경 이미지 */}
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  {currentCategory.items.map((item, index) => (
                    ...
                    >
                      {/* 메뉴 이미지 */}
                      <div className="aspect-square relative overflow-hidden bg-red-200">
                        <Image
                          src={item.image}
                          alt={item.name}
                          fill
